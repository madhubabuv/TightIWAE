...
piwaes = [folder+"log_PIWAE_M8_k8_repeat10.h5"]
miwaes = [folder+"log_MIVAE_M8_k8_repeat10.h5"]
iwaes = [folder+"log_MIVAE_M1_k64_repeat10.h5"]
vaes = [folder+"log_MIVAE_M1_k1_repeat10.h5"]
ciwaes = [folder+"log_CIVAE_beta0.5_repeat10.h5"]
